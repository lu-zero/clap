...
5. [Try it!](#try-it)
   ...
   2. [BYOB (Build Your Own Binary)](#byob-build-your-own-binary)
6. [Usage](#usage)
...
7. [Contributing](#contributing)
   1. [Compatibility Policy](#compatibility-policy)
      1. [Warning about '~' Dependencies](#warning-about--dependencies)
      2. [Minimum Supported Version of Rust (MSRV)](#minimum-supported-version-of-rust-msrv)
